...
See the [Try the Android Sample App](/sdks-and-tools/android/guides/try-the-sample-app) guide to run the sample app and see the full authentication lifecycle end to end.
