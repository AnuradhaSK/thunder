...
<CodeGroup>
  ...
  <CodeBlock lang="bash" label="Bun">
    bun add @thunderid/express
  </CodeBlock>

  <CodeBlock lang="bash" label="Deno">
    deno add npm:@thunderid/express
  </CodeBlock>
</CodeGroup>
...
See the [redirect flow guide](/sdks-and-tools/express/guides/redirect-flow) for the full route wiring pattern.
...
See the [embedded sign-in guide](/sdks-and-tools/express/guides/embedded-sign-in) for the request and response lifecycle.
