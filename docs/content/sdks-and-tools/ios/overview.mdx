...
See the [Try the iOS Sample App](/sdks-and-tools/ios/guides/try-the-sample-app) guide to run the sample app and see the full authentication lifecycle end to end.
...
To get started quickly, follow the [iOS Quickstart Guide](../../../getting-started/connect-your-application/ios) for step-by-step setup instructions.
