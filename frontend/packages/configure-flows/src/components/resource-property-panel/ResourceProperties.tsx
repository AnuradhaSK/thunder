...
import type {ResourcePropertiesProps} from '../../context/FlowBuilderCoreProvider';
import type {FieldKey, FieldValue} from '../../models/base';
import {ElementCategories, ElementTypes, type Element} from '../../models/elements';
