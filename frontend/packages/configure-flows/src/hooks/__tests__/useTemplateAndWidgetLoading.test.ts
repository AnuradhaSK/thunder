...
import {StepTypes, type Step} from '../../models/steps';
import {TemplateTypes, type Template} from '../../models/templates';
...
vi.mock('../useGenerateStepElement', () => ({
  default: () => ({
